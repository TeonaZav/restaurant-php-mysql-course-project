            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Welcome to <i class="fa fa-utensils text-primary me-2"></i>Dining Room</h1>
                        <p class="mb-4">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vero ipsa quod reiciendis neque adipisci deleniti nesciunt ut natus praesentium delectus optio repudiandae voluptate blanditiis!</p>
                        lorem
                        <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur, delectus deserunt atque repudiandae ratione dolor, vel ex blanditiis minima est sequi laborum corrupti nisi. </p>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating date" id="date3" data-target-input="nearest">
                                        <input name="booking_date" type="text" class="form-control datetimepicker-input" id="datetime" placeholder="Date & Time" data-target="#date3" data-toggle="datetimepicker" />
