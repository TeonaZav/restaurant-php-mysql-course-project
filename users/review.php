                            ...
                            <div class="row g-3">                 
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea name="review" class="form-control" placeholder="Type Review Here" id="message" style="height: 100px"></textarea>
                                        <label for="message">Type Review Here</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <button name="submit" class="btn btn-primary w-100 py-3" type="submit">Send</button>
                                </div>
                            </div>
                        </form>
                    </div>
